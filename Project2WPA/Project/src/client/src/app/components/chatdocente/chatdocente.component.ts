...
@Component({
  selector: 'app-chatdocente',
  templateUrl: './chatdocente.component.html',
  styleUrls: ['./chatdocente.component.css']
})
export class ChatdocenteComponent implements OnInit {
